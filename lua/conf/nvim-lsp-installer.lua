...
local function attach(client, bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "gd", "<cmd>Telescope lsp_definitions theme=dropdown<CR>", {noremap = true, silent = true})
    -- 列出光标下所有引用（代替内置 LSP 的窗口，telescope 插件让查看引用更方便）
    vim.api.nvim_buf_set_keymap(bufnr, "n", "gr", "<cmd>Telescope lsp_references theme=dropdown<CR>", {noremap = true, silent = true})
    -- 工作区诊断（代替内置 LSP 的窗口，telescope 插件让工作区诊断更方便）
    vim.api.nvim_buf_set_keymap(bufnr, "n", "go", "<cmd>Telescope diagnostics theme=dropdown<CR>", {noremap = true, silent = true})
    -- 显示代码可用操作（代替内置 LSP 的窗口，telescope 插件让代码行为更方便）
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>ca", "<cmd>Telescope lsp_code_actions theme=dropdown<CR>", {noremap = true, silent = true})
    -- 变量重命名（代替内置 LSP 的窗口，Lspsaga 让变量重命名更美观）
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>cn", "<cmd>Lspsaga rename<CR>", {noremap = true, silent = true})
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "g[", "<cmd>Lspsaga diagnostic_jump_prev<CR>", {noremap = true, silent = true})
    -- 跳转到下一个问题（代替内置 LSP 的窗口，Lspsaga 让跳转问题更美观）
    vim.api.nvim_buf_set_keymap(bufnr, "n", "g]", "<cmd>Lspsaga diagnostic_jump_next<CR>", {noremap = true, silent = true})
